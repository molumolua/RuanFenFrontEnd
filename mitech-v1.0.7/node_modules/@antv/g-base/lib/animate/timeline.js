...
async function main(){
    util_1 = await import("@antv/util");
    d3Timer = await import("d3-timer");
    d3_interpolate_1 =await  import("d3-interpolate"); // 目前整体动画只需要数值和数组的差值计算
    register_1 = await import("./register");
    PathUtil =await  import("../util/path");
    color_1 = await import("../util/color");

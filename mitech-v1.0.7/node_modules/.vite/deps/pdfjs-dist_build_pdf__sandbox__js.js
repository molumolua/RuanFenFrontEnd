...
var require_pdf_sandbox = __commonJS({
  "node_modules/pdfjs-dist/build/pdf.sandbox.js"(exports, module) {
            ...
            (__unused_webpack_module, exports2) => {
              ...
              var Module = (() => {
                ...
                return function(Module2) {
                  ...
                  var noExitRuntime = c.noExitRuntime || true;
                  "object" != typeof WebAssembly && w("no native wasm support detected");
                  var x, y = false;
                  function z(a, b, d, e) {
                    var f = { string: function(l) {
                      var p = 0;
                  ...
                  function I(a, b) {
                    for (var d = b + NaN, e = b; a[e] && !(e >= d); )
                      ++e;
                    if (16 < e - b && a.buffer && H)
                      return H.decode(a.subarray(b, e));
                    for (d = ""; b < e; ) {
                      var f = a[b++];
                      if (f & 128) {
                        var g = a[b++] & 63;
...
${d}`;
                  ...
                  function Z() {
                    function a() {
                      if (!Y && (Y = true, c.calledRun = true, !y)) {
                        V(da);
                        h(c);
            ...
            (__unused_webpack_module, exports2) => {
              ...
              exports2.SandboxSupportBase = void 0;
                ...
                createSandboxExternals() {
                  ...
                  return (name, args) => {
                    try {
                      ...
                      throw this.createErrorForSandbox((error == null ? void 0 : error.toString()) ?? "");
                    }
                  };
                }
              }
              exports2.SandboxSupportBase = SandboxSupportBase;
            }
            /******/
          ];
          ...
          (() => {
            ...
            exports2.QuickJSSandbox = QuickJSSandbox;
            ...
            class Sandbox {
              constructor(win, module2) {
                this.support = new SandboxSupport(win, this);
                module2.externalCall = this.support.createSandboxExternals();
              ...
              dispatchEvent(event) {
                var _a;
                (_a = this.support) == null ? void 0 : _a.callSandboxFunction("dispatchEvent", event);
              }
              dumpMemoryUse() {
                if (this._module) {
            ...
            function QuickJSSandbox() {
              return (0, _quickjsEval.default)().then((module2) => {
                return new Sandbox(window, module2);
              });
            }
          })();
          return __webpack_exports__;
...
export default require_pdf_sandbox();
//# sourceMappingURL=pdfjs-dist_build_pdf__sandbox__js.js.map

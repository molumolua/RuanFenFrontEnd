        ...
        (() => {
          ...
          var __webpack_modules__ = [
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              __privateAdd(PDFLinkService, _isValidExplicitDestination);
            ...
            /***/
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              var _numAnnotations, _onPresentationModeChanged, _updatePresentationModeState, updatePresentationModeState_fn;
              Object.defineProperty(exports2, "__esModule", {
                value: true
              });
              exports2.AnnotationLayerBuilder = void 0;
              var _pdfjsLib = __w_pdfjs_require__2(4);
              var _l10n_utils = __w_pdfjs_require__2(5);
              var _ui_utils = __w_pdfjs_require__2(2);
              class AnnotationLayerBuilder {
                constructor({
                  ...
                  __privateAdd(this, _numAnnotations, 0);
                ...
                async render(viewport, intent = "display") {
                  var _a;
                  if (this.div) {
                    if (this._cancelled || __privateGet(this, _numAnnotations) === 0) {
                      return;
                    }
                  ...
                  __privateSet(this, _numAnnotations, annotations.length);
                  this.div = document.createElement("div");
                  this.div.className = "annotationLayer";
                  this.pageDiv.append(this.div);
                  if (__privateGet(this, _numAnnotations) === 0) {
                    this.hide();
                    return;
                  }
            ...
            (__unused_webpack_module, exports2) => {
              ...
              exports2.fixupLangCode = fixupLangCode;
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              var _ui_utils = __w_pdfjs_require__2(2);
              var _pdf_find_utils = __w_pdfjs_require__2(11);
              var _pdfjsLib = __w_pdfjs_require__2(4);
              const FindState = {
                FOUND: 0,
                NOT_FOUND: 1,
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              var _ui_utils = __w_pdfjs_require__2(2);
              var _event_utils = __w_pdfjs_require__2(7);
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              var _annotation_layer_builder = __w_pdfjs_require__2(3);
              var _app_options = __w_pdfjs_require__2(15);
              var _l10n_utils = __w_pdfjs_require__2(5);
              var _pdf_link_service = __w_pdfjs_require__2(1);
              ...
              class PDFPageView {
                ...
                update({
                  ...
                  __privateMethod(this, _setDimensions, setDimensions_fn).call(this);
                  if (this._isStandalone) {
                    (_a = this.div.parentNode) == null ? void 0 : _a.style.setProperty("--scale-factor", this.viewport.scale);
                  }
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              var _ui_utils = __w_pdfjs_require__2(2);
              const _TextAccessibilityManager = class {
                constructor() {
              ...
              __privateAdd(TextAccessibilityManager, _compareElementPositions);
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              exports2.docPropertiesLookup = docPropertiesLookup;
              var _pdfjsLib = __w_pdfjs_require__2(4);
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              var _ui_utils = __w_pdfjs_require__2(2);
              var _pdf_viewer = __w_pdfjs_require__2(24);
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              var _pdf_rendering_queue = __w_pdfjs_require__2(25);
              var _pdf_link_service = __w_pdfjs_require__2(1);
                  ...
                  Promise.all([firstPagePromise, permissionsPromise]).then(([firstPdfPage, permissions]) => {
                    ...
                    if (annotationEditorMode !== _pdfjsLib.AnnotationEditorType.DISABLE) {
                      ...
                      if (pdfDocument.isPureXfa) {
                        ...
                        __privateSet(this, _annotationEditorUIManager, new _pdfjsLib.AnnotationEditorUIManager(this.container, this.eventBus, pdfDocument == null ? void 0 : pdfDocument.annotationStorage));
                    ...
                    __privateMethod(this, _onePageRenderedOrForceFetch, onePageRenderedOrForceFetch_fn).call(this).then(async () => {
                      var _a2, _b2;
                      (_a2 = this.findController) == null ? void 0 : _a2.setDocument(pdfDocument);
          ...
          (() => {
            ...
            exports2.DefaultXfaLayerFactory = exports2.DefaultTextLayerFactory = exports2.DefaultStructTreeLayerFactory = exports2.DefaultAnnotationLayerFactory = void 0;
            ...
            exports2.DefaultStructTreeLayerFactory = DefaultStructTreeLayerFactory;
            ...
            exports2.DefaultXfaLayerFactory = DefaultXfaLayerFactory;
          })();

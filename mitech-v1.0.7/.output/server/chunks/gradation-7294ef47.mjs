...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/element/gradation.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const gradation = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { gradation as default };
//# sourceMappingURL=gradation-7294ef47.mjs.map
